...
<div class="col-4">
  ...
  <fieldset>
    ...
    <div class="mb-3">
      ...
      <input type="text" name="material_name" value="<?php echo $row['material_name'] ?>" id="disabledTextInput" class="form-control" placeholder="Nhập...">
      <div class="text-danger"> <?php echo isset($error['material_name']) ? $error['material_name']:''; ?> </div>
    </div>
    <button type="submit" onclick="if(ConfirmUpdate()==0) return false" name="edit_material" class="btn btn-primary">Sửa</button>
  </fieldset>
</form>
</div>
